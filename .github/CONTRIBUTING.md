...
|----------------------|-----------------------|
|Create a issue        |[link](https://github.com/osbc2022/interactive-eloquent-js-website/edit/main/.github/CONTRIBUTING.md#-create-a-issue--ask-to-get-assigned-to-existing-issues--)       |
|Fork the repo         |[link](https://github.com/osbc2022/interactive-eloquent-js-website/blob/main/.github/CONTRIBUTING.md#1-fork-the-project-)       |
|Clone the repo        |[link](https://github.com/osbc2022/interactive-eloquent-js-website/blob/main/.github/CONTRIBUTING.md#2-clone-the-fork-)       |
|Add remote links      |[link](https://github.com/osbc2022/interactive-eloquent-js-website/blob/main/.github/CONTRIBUTING.md#3-add-remote-links-)       |
|Create a branch       |[link](https://github.com/osbc2022/interactive-eloquent-js-website/blob/main/.github/CONTRIBUTING.md#4-create-a-branch)       |
|Make changes          |[link](https://github.com/osbc2022/interactive-eloquent-js-website/blob/main/.github/CONTRIBUTING.md#5-make-required-changes-smile)       |
|Stage, commit & push  |[link](https://github.com/osbc2022/interactive-eloquent-js-website/blob/main/.github/CONTRIBUTING.md#6-stage-commit--push-)       |
|Make a PR :smile:     |[link](https://github.com/osbc2022/interactive-eloquent-js-website/blob/main/.github/CONTRIBUTING.md#7-make-a-pr-pull-request)       |
...
- the repository in which you want to contribute, in this case `osbc2022/interactive-eloquent-js-website`, we will call this the __*"original repo"*__
...
- This will create a copy of the project in your repositories section. example `your-github-user-name/
interactive-eloquent-js-website` we will call this a __*"forked repo"*__
...
```Shell
$ git clone https://github.com/osbc2022/interactive-eloquent-js-website
``` 
Now you have the project on your local machine.

- now go to that directory 
```Shell 
$ cd ./interactive-eloquent-js-website
```

> _Tip :- :heavy_check_mark: write `cd intera` and press `Tab` key for autocompletion in the terminal._
...
```Shell
$ git add remote upstream https://github.com/osbc2022/interactive-eloquent-js-website
```
